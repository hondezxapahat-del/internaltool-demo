"""Shared retrieval logic: embed a query and fetch similar chunks from Supabase.

Same hybrid-search shape as the client-facing project's retrieval.py, but
every result carries `source_document` — this project's whole point is
reporting *which* document matched, not just answering from a pooled corpus.
"""
