...
Adapted from the client-facing project's embed_and_store.py — the one
difference is every row also records which source file it came from
(`source_document`), since this project's whole point is reporting which
specific document a match belongs to.
"""
